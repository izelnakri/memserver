...
export default function(modelFixtureTree, Server) {  /// { User: { fixtures: [], model: {} }}
  if (!Server) {
  ...
  targetNamespace.MemServer = {
    ...
    start(options={ logging: true }) {
      ...
      this.Server = startServer(Server, options); // NOTE: maybe customize it here, make it shorter
